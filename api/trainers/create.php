...
try {
    ...
    $max_clients    = isset($data['max_clients']) ? (int)$data['max_clients'] : 10;
    ...
    $sqlTrainer = "INSERT INTO trainers (user_id, name, specialization, contact, email, bio, photo_url, is_active, availability, certifications, max_clients)
                   VALUES ($userId, '$name', '$specialization', '$contact', '$email', '$bio', '$photo_url', $is_active, '$availability', '$certifications', $max_clients)";
