...
<head>
    ...
    <style>
        ...
        .profile-drawer {
            ...
            background: var(--dark-card); border-left: 2px solid var(--dark-border);
            z-index: 2001; overflow-y: auto; transition: right 0.35s cubic-bezier(0.4,0,0.2,1);
        ...
        <div class="content-card" style="margin-top:32px;">
            ...
            <div class="filter-bar">
                <div style="display:flex;align-items:center;gap:8px;">
                    ...
                    <select id="filterSpec" onchange="filterTrainers()">
                ...
                <form id="trainerForm">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="trainerMaxClients" min="1" max="100" value="10" placeholder="10">
                        </div>
                    </div>
